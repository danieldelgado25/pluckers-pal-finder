...
const en: Dict = {
  ...
  "menu.title": "Menu",
  "menu.sub": "Five sections. Tap to expand what you're hungry for.",
  "menu.filter.all": "All",
  "menu.filter.label": "Filter entrées",
  "menu.expand": "Expand all",
  "menu.collapse": "Collapse all",
  "menu.availability": "Available at",
  ...
  "menu.allergen.updated": "Last reviewed",
