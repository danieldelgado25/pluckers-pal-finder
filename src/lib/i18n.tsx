...
const es: Dict = {
  ...
  "menu.title": "Menú",
  "menu.sub": "Ve directo a lo que se te antoje.",
  "menu.jump": "Ir a",
  "menu.filter.all": "Todo",
  "menu.filter.label": "Secciones de platos fuertes",
  "menu.seeSauces": "Ver todas las salsas y su nivel de picor",
  ...
  "drink.cocktails": "Cocteles",
  "drink.margaritas": "Margaritas",
  "drink.draft": "Cerveza de barril",
  "drink.cans": "Botellas y latas",
  "drink.wine": "Vino",

  "nav.sauces": "Salsas",
  "sauces.title": "Salsas para alitas",
  "sauces.sub": "Salsas y sazones secos hechos en casa, con su nivel de picor.",
  "sauces.heat": "Nivel de picor",
  "sauces.heatLegend": "Cinco flamas es territorio Fire in the Hole.",
  "sauces.backToMenu": "Volver al menú",
  "sauce.featured": "Salsa destacada",
  "sauce.marks": "Favoritas de Mark",
  "sauce.daves": "Favoritas de Dave",
  "sauce.seans": "Favoritas de Sean",
  "sauce.originals": "Originales Pluckers",
